...
using MVC_withAutomapper.Data;
using MVC_withAutomapper.DTO;
using MVC_withAutomapper.Models;

namespace MVC_withAutomapper.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        {
            var categorydto = AutoMapper.Mapper.Map<IEnumerable<CategoryDto>>(db.Categories.Include(c=>c.Products).ToList());
